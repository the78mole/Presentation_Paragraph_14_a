...
\newcommand{\smp}{\includegraphics[width=0.2cm]{images/party.png}}
\newcommand{\sml}{\includegraphics[width=0.2cm]{images/lacheln.png}}
\newcommand{\smn}{\includegraphics[width=0.2cm]{images/neutral.png}}
\newcommand{\sms}{\includegraphics[width=0.2cm]{images/traurig.png}}
...
\include{subdocs/01_intro}

\include{subdocs/02_technical}

\include{subdocs/03_commercial}

\include{subdocs/04_regional}

\include{subdocs/99_outro}
